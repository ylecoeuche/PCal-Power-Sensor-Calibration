...
fid = fopen('setPCAL_D20180507T1545_RAT_WS1_GS.m', 'w');
fprintf(fid, '%% Setting variable PCAL_D20180507T1545_RAT_WS1_GS,\n');
fprintf(fid, '%% which is ratio of WS1 response over GS response measured on 2018-05-07T1545.\n');
fprintf(fid, 'PCAL_D20180507T1545_RAT_WS1_GS = %.6e;\n', rat_dev2_dev1);
fclose(fid);
...
svn add 2018-05-07T1545_rat_WS1_GS
svn commit -m "Pcal. 2018-05-07T1545, ratio WS1 / GS measurements."
svn update
